...
public class Main {
    ...
    public static int[] heroesHealth = {280, 270, 250, 350, 700, 160, 350, 300};
    public static int[] heroesDamage = {10, 15, 20, 0, 5, 0, 10, 0};
    ...
    public static void Berserk() {
        ...
        for (int i = 0; i < heroesHealth.length; i++) {
            ...
            if (heroesHealth[6] > 0) {
                heroesHealth[6] += sheld;
                if (heroesDamage[6] <= 30) {
                    heroesDamage[6] += sheld;
                }
                break;
            }
        }
    ...
    public static void golemSkill() {
        for (int i = 0; i < heroesHealth.length; i++) {
            ...
            if (heroesHealth[4] > 0) {
                int golemDamageTake = bossDamage / 5;
                heroesHealth[4] -= golemDamageTake;
                heroesHealth[i] -= bossDamage - golemDamageTake;
            } else {
